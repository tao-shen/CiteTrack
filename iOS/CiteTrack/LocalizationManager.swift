...
public class LocalizationManager: ObservableObject {
    ...
    private func loadJapaneseLocalizations() {
        localizations[.japanese] = [
            ...
            "visit_google_scholar": "Google Scholarにアクセス",
            ...
            "invalid_scholar_id_format": "研究者IDの形式が無効です",
            ...
            "last_sync": "最終同期",
            "icloud_data_found": "iCloudデータが見つかりました",
            "icloud_available_no_sync": "iCloud利用可能、未同期",
            ...
            "no_citetrack_data_in_icloud": "iCloudにCiteTrackデータが見つかりません。",
