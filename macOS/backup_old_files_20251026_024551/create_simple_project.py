...
# 创建项目目录
Path("CiteTrack_macOS.xcodeproj/project.xcworkspace").mkdir(parents=True, exist_ok=True)
...
\t\t{ICON_BUILD} /* app_icon.icns in Resources */ = {{isa = PBXBuildFile; fileRef = {ICON_REF} /* app_icon.icns */; }};
...
\t\t{ICON_REF} /* app_icon.icns */ = {{isa = PBXFileReference; lastKnownFileType = image.icns; name = app_icon.icns; path = assets/app_icon.icns; sourceTree = "<group>"; }};
...
\t\t\tbuildActionMask = 2147483647;
\t\t\tfiles = (
\t\t\t\t{ICON_BUILD} /* app_icon.icns in Resources */,
\t\t\t);
\t\t\trunOnlyForDeploymentPostprocessing = 0;
\t\t}};
...
print("\n🚀 可以打开项目了：")
print("   open CiteTrack_macOS.xcodeproj")
